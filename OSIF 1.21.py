...
class OSIF:
    ...
    def PerformSim(self):
        ...
        if len(self.activeData.rawzPrime) == 0:
            ...
            params = [float(self.Lwire.IE.get()), float(self.Rmem.IE.get()), float(self.Rcl.IE.get()),
                      float(self.Qdl.IE.get()), float(self.Phi.IE.get())]
    ...
    def PerformFit(self):
        ...
        if len(self.activeData.rawzPrime) == 0:
            ...
            params = [float(self.Lwire.IE.get()) / float(self.area.IE.get()),
                      ...
                      float(self.Rcl.IE.get()) / float(self.area.IE.get()), float(self.Qdl.IE.get()),
            ...
            print(len((finalOutput.fun / self.activeData.zMod * 100)))
    ...
    def CreateFigures(self, params, fitOrSim):
        ...
        nyGraph.plot(self.funcreal(params), self.funcImg(params), 'ro', markersize=2,
                     label='\n%s\nLwire=%.5e\nRmem=%5.8f\nRcl=%5.8f\nQdl=%5.5f\nphi=%5.5f' % (
                     graphLabel, params[0], params[1], params[2], params[3], params[4]))
